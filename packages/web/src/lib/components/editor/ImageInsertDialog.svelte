<script lang="ts">
	...
	type Props = {
		...
		onTargetChange: (targetId: string) => void | Promise<unknown>;
			...
			>
				...
				<div class="mt-4">
					...
					<select
						...
						class="mt-3 w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-200 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-sky-500 dark:focus:ring-sky-900/60"
					...
					<div>
						...
						<div class="mt-3 flex flex-col gap-2 sm:flex-row">
							<input
								...
								autocomplete="off"
								spellcheck="false"
								class="min-w-0 flex-1 rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-200 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-sky-500 dark:focus:ring-sky-900/60"
