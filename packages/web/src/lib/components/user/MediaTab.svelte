...
<div class="space-y-4">
	<div class="grid gap-3 rounded-xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700/50 dark:bg-zinc-800/20 sm:grid-cols-[minmax(0,1fr)_150px_170px_auto]">
		<input
			...
			class="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-800 outline-none transition focus:border-sky-300 focus:ring-2 focus:ring-sky-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-sky-400 dark:focus:ring-sky-950/40"
			onkeydown={async (e) => {
				if (e.key === 'Enter') {
					e.preventDefault();
					await applyFilters();
		...
		<select
			bind:value={kind}
			class="rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-800 outline-none transition focus:border-sky-300 focus:ring-2 focus:ring-sky-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-sky-400 dark:focus:ring-sky-950/40"
		...
		<button
			type="button"
			class="rounded-lg bg-sky-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-sky-600 dark:bg-sky-500 dark:text-white dark:hover:bg-sky-400"
