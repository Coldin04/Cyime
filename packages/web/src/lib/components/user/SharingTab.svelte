		...
		>
			...
			<div class="space-y-6 p-4">
				...
				<div class="flex justify-end gap-2">
					...
					<button
						type="button"
						class="rounded-lg bg-sky-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-sky-600 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-sky-500 dark:text-white dark:hover:bg-sky-400"
